...
export default function SobremesasScreen() {
  ...
  const sobremesas = produtos.filter((item) => item.categoria === 'sobremesa');

  const filtrados = sobremesas.filter((item) =>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.containerTitle}>
          ...
          <Image
            source={require('../../assets/icons/icon-bolo.png')}
          ...
          ListEmptyComponent={
            <View style={styles.containerNotFound}>
              ...
              <Text style={styles.textNotFound}>
                Ops! Nenhuma sobremesa foi encontrada.
              </Text>
            </View>
          }
        />
